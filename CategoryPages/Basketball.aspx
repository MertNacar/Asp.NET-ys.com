<%@ Page Title="" Language="C#" MasterPageFile="~/CategoryPages/Categories.Master" AutoEventWireup="true" CodeBehind="Basketball.aspx.cs" Inherits="WebProje.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="row text-light font-italic lead" style="             
              margin: 50px;
              background-color:#ba4925;
    ...
    <div class="row" style="margin: 50px; background-image: url(../Content/images/basketBack.jpg);
              background-repeat:repeat; box-shadow: 12px 12px black;">
